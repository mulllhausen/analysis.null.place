var latestCache = '2018-11-07_00:11:54';
self.addEventListener('install', function (event) {
    event.waitUntil(
        caches.open(latestCache).then(function (cache) {
            return cache.addAll([
                // common assets for all pages
                'https://analysis.null.place/theme/css/thematrix.css?hash=SxnK0SQOHR_NOYA0OF1TVXcW36jUMJO9ut478t1x44s',
                ...
                'https://analysis.null.place/theme/js/base.js?hash=18c49CWc3VmWOm3mXHoHy0iR6hj6t0jnsJ2k1XPYD94',
